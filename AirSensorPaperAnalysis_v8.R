...
# Analysis to accompy the manuscript: "AirSensor v1.0: Enhancements to the open-source R package to enable deep 
...
# Figure 5a
plot(senFunc$date, senFunc_sum, ylab = "Number of Sensors (#)")
...
# Figure 5b
plot(senFunc$date, totComplete_sum/senFunc_sum*100, ylab = "Percent of Sensors Providing Valid Data", ylim = c(0,110))

# Figure 5c
plot(senFunc$date, totQAQCPass_sum/senFunc_sum*100, ylab = "Percent of Sensors Providing Data Passing QA/QC", 
     ylim = c(0,110))
